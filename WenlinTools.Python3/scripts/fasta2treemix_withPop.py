...
if __name__=='__main__':
    ...
    try:
        ...
        print("the popdef is file, each line of which contains sample ID and popName", file=sys.stderr)
        sys.exit()


    seqDict = read_fa(fn)

    popDict = parse_popDef_newFormat(fpopdef)
